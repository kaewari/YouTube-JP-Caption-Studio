...
| `master-caption-translate-2026-07-28` | **partial** | Caption pipeline / overlay / ownership live. Nice-to-haves cancelled (YAGNI). **Open gap:** planned MT queue (`POST /translate_segment`, `translate.py`) not in flat bridge — same as auto-dịch |
