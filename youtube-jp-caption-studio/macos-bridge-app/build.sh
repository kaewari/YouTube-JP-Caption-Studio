...
REPO="$(cd "$ROOT/.." && pwd)"
# Monorepo: youtube-jp-caption-studio/../ipad-app
MONOREPO="$(cd "$REPO/.." && pwd)"
BRIDGE="$REPO/local-bridge"
SRC_ICON="${SRC_ICON:-$MONOREPO/ipad-app/Assets.xcassets/AppIcon.appiconset/AppIcon.png}"
