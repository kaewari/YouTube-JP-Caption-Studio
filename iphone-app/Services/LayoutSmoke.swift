...
enum LayoutSmoke {
    static func run() {
        ...
        // Intentional: masthead + title/owner hide (not whole #below / related).
        assert(src.contains("ytd-masthead"), "hide YT masthead")
        assert(src.contains("ytd-watch-metadata #owner"), "hide title/owner row")
